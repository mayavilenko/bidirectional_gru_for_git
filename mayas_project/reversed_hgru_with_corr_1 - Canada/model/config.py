...
LayersDim = 1
DropoutProb = 0.0
#Lr = 0.09262889546468263 #after running optuna
#Lr = 0.032893502979809225 #post optuna (2nd time)

#Lr = 0.09989190903639084 #post optuna 3rd time
#loss_coef_3 = 1*np.exp(-6)
