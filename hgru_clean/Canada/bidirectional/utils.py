...
def training_and_evaluation(model, category_indent, train_dataloader, test_dataloader, optim, category, weights_dict, coefficient_dict, son_parent_dict, parent_to_son_list_dict, category_id_to_name_dict, loss_coef_1, loss_coef_2, loss_coef_3, alpha, path): 
